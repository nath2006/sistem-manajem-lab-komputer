...
const LoginPage = () => {
  ...
  useEffect(() => {
    if (state.isAuthenticated) {
      ...
      }else if (state.role === "Kepala Lab") {
        navigate('/dashboard-kepala-lab');
      } else if (state.role === "Koordinator Lab") {
        navigate('/dashboard-koordinator-lab');
  ...
  const announcements = [
    {
      ...
      date: "21 Juni 2025",
      content:
        "Berikut jadwal blok penggunaan lab untuk minggu depan. Harap diperhatikan.",
    ...
    },
    {
      ...
      date: "15 Juni 2025",
      content:
        "Akan dilakukan pemeliharaan rutin pada semua lab komputer setiap hari Sabtu.",
      image: "/assets/images/pengumuman.png",
    },
    {
      id: 3,
      ...
      date: "10 Juni 2025",
      content:
        "Pelatihan software terbaru akan dilaksanakan untuk semua pengguna lab.",
      image: "/assets/images/pengumuman.png",
    },
  ];
  const nextSlide = () => {
  ...
  const getCardPosition = (index) => {
    const position =
      (index - currentIndex + announcements.length) % announcements.length;

    switch (position) {
      case 0:
        return "z-30 top-0 left-0 right-0 opacity-100";
      case 1:
        return "z-20 top-4 left-4 right-4 opacity-80";
      case 2:
        return "z-10 top-8 left-8 right-8 opacity-60";
      default:
        return "hidden";
    }
  };
          ...
          <div className="flex flex-col gap-8 w-full">
            <div>
              ...
              <p className="text-white/90 mt-1">
                Update terbaru penggunaan laboratorium komputer
              </p>
            </div>
              ...
              {announcements.map((item, index) => (
                ...
                >
                  <Card className="flex md:w-md cursor-pointer hover:shadow-xl transition-shadow !bg-white">
                    ...
                    />
                    <div className="p-4">
                      <h5 className="text-xl font-bold text-gray-">
                        {item.title}
                      </h5>
